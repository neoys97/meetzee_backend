...
This is a sample template for meetzee_lambda - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name meetzee_lambda --tail
```
...
```bash
aws cloudformation delete-stack --stack-name meetzee_lambda
```
